...
import { ROOT_URL, CLS_DISEASE_FEATURE } from "~/util/constants.js";
import { polyglot } from "jet-locales/ru.js";
import { filterTable, fetchData } from "~/util/api";

export default class DiseaseFeatureView extends JetView {
  config() {
    return {
      rows: [
        {
        ...
        },
        {
          ...
          columnWidth: 200,
          url: () => {
            return fetchData(CLS_DISEASE_FEATURE);
          },
  ...
  init() {
    $$("table").attachEvent("onItemDblClick", item =>
      this.app.show("/top/cls-disease-feature-form?id=" + item.row)
    );
  }
}
