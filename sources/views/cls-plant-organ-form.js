...
import { CLS_PLANT_ORGAN, ROOT_URL } from "~/util/constants.js";
import { saveRow, deleteRow, updateRow } from "~/util/api";
import { polyglot } from "jet-locales/ru.js";

export default class PlantOrganFormView extends JetView {
  config() {
    this.item = {};
    return {
      rows: [
              ...
              cols: [
                {
                  ...
                  id: "save",
                  click: () => saveRow(CLS_PLANT_ORGAN, this.item)
                },
                {
                  view: "button",
                  value: polyglot.t("form.delete"),
                  id: "delete",
                  click: () => deleteRow(CLS_PLANT_ORGAN, this.id)
                },
                {
                  view: "button",
                  value: polyglot.t("form.update"),
                  id: "update",
                  click: () => updateRow(CLS_PLANT_ORGAN, this.item, this.id)
                }
              ]
            }
          ]
