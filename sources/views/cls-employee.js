...
import { ROOT_URL, CLS_EMPLOYEE } from "~/util/constants.js";
import { polyglot } from "jet-locales/ru.js";
import { filterTable, fetchData } from "~/util/api";

export default class EmployeeView extends JetView {
  config() {
    return {
      rows: [
        {
  ...
  init() {
    $$("table").attachEvent("onItemDblClick", item =>
      this.app.show("/top/cls-employee-form?id=" + item.row)
    );
  }
}
