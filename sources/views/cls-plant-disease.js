...
import { ROOT_URL, CLS_PLANT_DISEASE } from "~/util/constants.js";
import { polyglot } from "jet-locales/ru.js";
import { filterTable, fetchData } from "~/util/api";

export default class PlantDiseaseView extends JetView {
  config() {
    return {
      rows: [
        {
        ...
        },
        {
          ...
          columnWidth: 200,
          url: () => {
            return fetchData(CLS_PLANT_DISEASE);
          },
  ...
  init() {
    $$("table").attachEvent("onItemDblClick", item =>
      this.app.show("/top/cls-plant-disease-form?id=" + item.row)
    );
  }
}
