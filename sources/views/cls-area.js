...
import { ROOT_URL, CLS_AREA } from "~/util/constants.js";
import { polyglot } from "jet-locales/ru.js";
import { filterTable, fetchData } from "~/util/api";

export default class AreaView extends JetView {
  config() {
    return {
      rows: [
        {
  ...
  init() {
    $$("table").attachEvent("onItemDblClick", item =>
      this.app.show("/top/cls-area-form?id=" + item.row)
    );
  }
}
