...
import { ROOT_URL, CLS_WORK_TYPE } from "~/util/constants.js";
import { polyglot } from "jet-locales/ru.js";
import { filterTable, fetchData } from "~/util/api";

export default class WorkTypeView extends JetView {
  config() {
    return {
      rows: [
        {
        ...
        },
        {
          ...
          columnWidth: 200,
          url: () => {
            return fetchData(CLS_WORK_TYPE);
          },
  ...
  init() {
    $$("table").attachEvent("onItemDblClick", item =>
      this.app.show("/top/cls-work-type-form?id=" + item.row)
    );
  }
}
